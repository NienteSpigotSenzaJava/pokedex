...
import { AgentConfigSchema, ThreadStartSchema, mcpToolNames, stableCapabilities } from "../packages/protocol/src/index.js";
...
describe("protocol schemas", () => {
  ...
  it("declares native app-server capabilities", () => {
    expect(stableCapabilities.some((capability) => capability.name === "native_threads" && capability.source === "app_server")).toBe(true);
  });
